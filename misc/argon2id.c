 ...
 */
//gcc -O2 -o test argon2id.c -L../lib -lcrypto -I../compiled/include
#include <stdio.h>
 ...
 */
static uint32_t memory_cost    = 32*32*1024;
static uint32_t iteration_cost =  3+60;
static uint32_t parallel_cost  =  4+80;
